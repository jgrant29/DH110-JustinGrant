...
For my specific task, I was able to control the checkout process easily.  SHRM's bookstore gave me the freedom to add products to cart, increase or decrease quantity, estimate shipping and handling, and edit my shipping and billing adress.  

Overall, I give the checkout process  a **4** because the user has the freedom to modifying their cart and information with freedom. 
...
On my specific task of finding a product and checking out, I found the error prevention lacking substantial information and notifications for the user.  For example, when I attempted to checkout without entering a phone number, the website told me to enter a valid phone number.  However, when I entered valid phone number and pressed "Next" the  checkout page still told me to  enter a valid phone number. I eventually found another error towards the bottom of the form that told me to enter a valid shipping address.  When attempting to checkout again without entering a state, the form indicated that I needed to provide a valid state, but the phone number warning was still present event though I entered a valid phone number. 
