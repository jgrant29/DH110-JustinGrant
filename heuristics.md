...
I am the web developer and designer for a company that produces HR material for employers and HR Professionals.  This project's goal is to help me understand how HR websites differ from hrsimple.com. I intend to learn what is missing from hrsimple.com by performing heuristics on competitor websites. 
...
HR.my is a website for employers to track employee information.  HR.my allows employers to set specific tasks for employees like clocking into work or requesting vacation time.  Most of all, the website is tailored for both employers and employees.  The employer sets up the account and tracks their employee, and the employee gets access to the site to view their information and request specific actions. 

Overall, the website is minimal in design but needs significant improvement.  The website is free to use, but the web developer does ask for donations, too. I signed up for free and was notified with an informative error message that I already had an account.  Requesting to change my password was simple and followed the usual standards.  However, the site has many advertisements on it, which seem to trick the user into clicking them when attempting to navigate the website.   For example, when I clicked on a link to learn how to enter employee information, an advertisement popped up.   There was no way to exit except for clicking on the background page of the popup modal. This issue supposedly goes away when you buy the developer a cup of coffee.

Also, I encountered an error when attempting to enter a job title for an employee.  The only reason I know an error occurred is due to my experience using websites. A spinning wheel, which indicates the website is doing something, popped up but it continues spinning.  **See screenshot below:** 
...
The language of HR.my is relevant to the real world of employee management.  The user dashboard has an accordion on the left side of the screen that is relevant to the industry. "Employee", "Expense Claim", "Leave", "Attendance", "Document Workflow", "Team", "Payroll", "Employer", and "My Account".  From there, there are more links to fund the developer of the platform, gain "Module Access", change the language of the website, "User Guide", and a few other options.  
...
The User Freedom on HR.my is subtle, simple, and easy to understand once I got used to the system.  User freedom is limited on HR.my.  There is very little freedom to undo an action, and when an action is, performed the user has to go through dialogue to modify the information.  The User account is limited and has few features to modify information.  
...
2. Recognition rather than recall: The website is not intuitive enough to have success with ambiguity.  A way to improve this problem is to add text and information to help guide a user to use the website without much cognitive load.   
3. Visibility of system status: As a user I was not sure what to do next or if a feature worked.  For example, it took me a few minutes to learn how to edit a database entry.  After realizing I had to like the entry then select "edit" did I understand what to do.  Simple tasks like this should don't involve more than one step.  Solution is consolidate the two step process into one. 
...
SHRM is an acronym that stands for Society for Human Resources Managers. It's a professional website that offers a wide-ranger of information for human resources professionals, lawyers, employers, and managers.  The company provides membership, certification for required human resources credits, products, articles, and in-person and virtual events worldwide.  My evaluation will focus on their "Resources" section, specifically with their "Employment Law".  The task I am trying to accomplish is to purchase a product that will help me comply with employment law. 

Overall, I think the website is robust and features many pieces of information, tools and resources for a diverse audience.  The look and feel of the website is professional.  I feel confident using the website because the aesthetic is rich, and the website provides information about the company.   
...
SHRM's Bookstore was hard to find when I landed on the initial website — shrm.org.  As an HR person, I was trying to find resources or products that would help me understand how to comply with employment law.  After clicking on the Resources link in the navigation bar, I selected the "Employment Law" link. I saw a visible status that I was on a "Resources" page, but I couldn't find the correct products or information I was looking for.  The signifiers was a header tag called "Employment Law".  I think a breadcrumb would have helped signify my status.  I eventually stumbled on the information I was looking after attempting to sign up.  The URL is listed here:  https://store.shrm.org/books-resources/hr-and-the-law/employment-law

When I landed on the bookstore page, there was a visible signal that I was on a bookstore because the page said "The SHRM Store, the World's Largest HR Store".  I started searching immediately, but couldn't find anything for the United States.  The resources available were from other countries. Nevertheless, on this page there was a visible signifier in navigation and breadcrumbs.  The downside to SHRM's visible system status was when I attempted to search through the Bookstore.  The only indication for loading status was a spinning wheel that was barely visible. 
...
3. Recognition rather than recall: THe information on SHRM.org is in-depth and expansive.  However, I think there is too much information on SHRM which leads to the user having to recall what to do and where to find things rather than recognize what to do and where to find information.  A solution is to consolidate the information architecture with a streamlined, focused set of pillars for the website instead of spreading the information all over the place. 
